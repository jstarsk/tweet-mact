...
if __name__ == "__main__":
    ...
    api = twitter.Api(consumer_key='HgCV9eVyQZSwgR3nzdwLn4R9V',
                      consumer_secret='hMZ5aM6tkbVMeuIohskiq6csMk9aNdejtlC7upAnNIZOD4ixED',
                      access_token_key='2819495812-ZfwrD8d6BgVBOZmDDCFS7qKgn7h57iCZphv3Etn',
                      access_token_secret='g5mThDGCpX4o5Ga1D3EuW3rQgXqoL5gXCgPRrUGSaCaYv')
    ...
    for trigger in trigger_times:
        ...
        while not is_stop:
            ...
            time_trigger = "%s %s" % (trigger["date"], trigger["hour"])

            if current_time == current_time:
                print("Algorithm is trigger at " + trigger["date"] + trigger["hour"])
                print("--------------------------------------------------------------------------")
